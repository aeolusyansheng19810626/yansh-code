...
def test_maybe_compact_over_threshold_compresses(monkeypatch):
    ...
    monkeypatch.setattr(agent, "_compact_messages", lambda m, keep_recent_pairs, plan_anchor=None, env_anchor=None: compacted)
    out = agent._maybe_compact_messages(msgs, state)
...
def test_maybe_compact_thrashing_disables(monkeypatch):
    ...
    monkeypatch.setattr(agent, "_compact_messages", lambda m, keep_recent_pairs, plan_anchor=None, env_anchor=None: m)
