...
yansh 是个命令行编程助手，从 5/21 起开发、加能力、做 review 修问题，5/23 起跟 Claude Code 子 agent 打 5 场 AB 对比 —— 写代码场景 yansh 慢且费 token（25×），论证场景差距收窄到 4×，跨文件重构靠改框架硬上限才能跑通。

---

## 第一周：5/21 — 把基础流程理顺

这一周主要解决"流程能不能跑通、跑通对不对"。
...
上半周加了一堆功能，下半周拉三家 LLM review 整改。

**前半周加的能力（笔记 11-22，按顺序）：**
...
## 第三周：5/23 — 跟 Claude Code 子 agent 打 5 场 AB
